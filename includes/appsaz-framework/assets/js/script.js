(function( $ ) {
        ...
        //Vertical Tab
        $('#app_options_tab').aofOptionsTabs({
          ...
          $('.aof-number').each(function() {
            ...
            $(this).prev().slider({
                    ...
                    change: function (event, ui) {
                        $(ui.handle).parent().next().val(ui.value).trigger('change');
                        // var menuwidth = jQuery("#admin_menu_width").val();
                        // if(menuwidth) {
                        //   $("#adminmenu, #adminmenu .wp-submenu, #adminmenuback, #adminmenuwrap").css({width: menuwidth + 'px'});
                        // }
                    },
               });
          });
