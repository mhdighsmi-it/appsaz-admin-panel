...
if($this->aap_options['design_type'] != 3) {
  ...
  #wpadminbar:not(.mobile) .ab-top-menu>li:hover>.ab-item,#wpadminbar:not(.mobile) .ab-top-menu>li>.ab-item:focus{
    background: ' . $this->aap_options['admin_bar_menu_bg_hover_color'] . '; color: ' . $this->aap_options['admin_bar_menu_hover_color'] . '}';
...
.quicklinks li.APPSAZADMIN_site_title {width: 180px !important;';
